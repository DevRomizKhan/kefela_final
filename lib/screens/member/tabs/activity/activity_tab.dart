...
import 'donation_report_tab.dart'; // Add this import
...
class _MemberActivityTabState extends State<MemberActivityTab>
  ...
  // ADD THIS NEW METHOD FOR DONATION REPORTS
  void _openDonationReports() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const DonationReportTab()),
    );
  }
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: _loadingCreatedAt
          ...
          child: Column(
            children: [
              // Four Summary Cards (Updated to include Donations)
              Expanded(
                child: ListView(
                  children: [
                    _buildSummaryCard(
